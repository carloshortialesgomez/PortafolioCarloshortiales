...
const translations = {
  es: {
    ...
    sobre_p2: 'Con experiencia en el desarrollo e integración de herramientas de IA (Gemini, Claude) con plataformas de datos (BigQuery, Tableau) para generar insights accionables en tiempo real. <strong>Tableau</strong> es mi herramienta principal de visualización y análisis.',
    ...
    section_projects_desc: 'Los proyectos más recientes e innovadores en integración de IA generativa con plataformas de datos empresariales para automatizar análisis y generar valor en operaciones de retail.',
    ...
    current_tag: 'Actual',
    atlas_desc: 'Líder de análisis de datos en <strong>Grupo Comercial Atlas</strong>, cadena de retail multicanal con presencia en México. Responsable de la automatización de operaciones eCommerce, construcción de pipelines de datos y la reciente integración de IA generativa en procesos analíticos.',
  ...
  en: {
    ...
    sobre_p2: 'With hands-on experience integrating AI tools (Gemini, Claude) with data platforms (BigQuery, Tableau) to generate actionable insights in real time. <strong>Tableau</strong> is my primary visualization and analysis tool.',
    ...
    section_projects_desc: 'The most recent and innovative projects combining generative AI with enterprise data platforms to automate analysis and generate value in retail operations.',
    ...
    current_tag: 'Current',
    atlas_desc: 'Data analytics lead at <strong>Grupo Comercial Atlas</strong>, a multi-channel retail chain operating in Mexico. Responsible for eCommerce operations automation, data pipeline construction, and the recent integration of generative AI into analytical processes.',
