...
const translations = {
  es: {
    ...
    current_tag: 'Actual',
    atlas_desc: 'Líder de análisis de datos en <strong>Grupo Comercial Atlas</strong>, cadena de retail multicanal con presencia en México. Responsable de la automatización de operaciones eCommerce y construcción de pipelines de datos.',
  ...
  en: {
    ...
    current_tag: 'Current',
    atlas_desc: 'Data analytics lead at <strong>Grupo Comercial Atlas</strong>, a multi-channel retail chain operating in Mexico. Responsible for eCommerce operations automation and data pipeline construction.',
